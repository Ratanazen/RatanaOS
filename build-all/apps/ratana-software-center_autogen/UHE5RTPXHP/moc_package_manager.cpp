...
#include <memory>
#include "../../../../apps/software-center/package_manager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_PackageManager_t qt_meta_stringdata_PackageManager = {
    {
        ...
        QT_MOC_LITERAL(15, 15),  // "operationOutput"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 6),  // "output"
        QT_MOC_LITERAL(39, 17),  // "operationFinished"
...
void PackageManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->operationOutput((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        ...
        {
            using _t = void (PackageManager::*)(const QString & );
            if (_t _q_method = &PackageManager::operationOutput; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PackageManager::*)(bool );
            if (_t _q_method = &PackageManager::operationFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void PackageManager::operationFinished(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
